...
const Products: NextPage<ProductsProps> = ({
  ...
  return (
    <section className="relative z-40 -mt-[100vh] flex min-h-screen flex-col items-center justify-center bg-[#1B1B1B]">
        ...
        <Tab.List className="flex justify-center ">
          {categories.map((category) => (
            <Tab
              ...
              id={category._id}
              className={({ selected }) =>
                ` whitespace-nowrap rounded-none rounded-t-lg py-3 px-5 text-sm font-light outline-none hover:text-white md:py-4 md:px-6 md:text-base ${
                  selected
